...
enum Appearance {
    ...
    static func setAppearance() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.white, NSAttributedString.Key.font: UIFont(name: "Montserrat-Bold", size: 19)!]
